...
class SingleMetrics:
    ...
    def rae(self):
        ...
        rae = abs((auc(self.original.index_for_year, self.original['capacity_factor']) - auc(
            self.representative.index_for_year, self.representative['capacity_factor']))) / auc(self.original.index_for_year, self.original['capacity_factor'])
